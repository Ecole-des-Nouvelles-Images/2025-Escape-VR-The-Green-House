...
Shader "Real Ivy/Flat leaves"
{
	Properties
	{
		...
		[ASEEnd]_WindPattern("Wind Pattern", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float4 appendResult87 = (float4(v.vertex.xyz.x , v.vertex.xyz.y , 0.0 , 0.0));
				...
				#endif
				float3 vertexValue = ( ( cos( temp_output_63_0 ) * float4( v.ase_normal , 0.0 ) * _Radius * v.ase_color.a ) + ( ( sin( temp_output_63_0 ) + -1.0 ) * float4( cross( v.ase_normal , v.ase_tangent.xyz ) , 0.0 ) * _Radius * v.ase_color.a ) ).rgb;
				#ifdef ASE_ABSOLUTE_VERTEX_POS
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 texCoord118 = IN.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
...
/*ASEBEGIN
Version=18707
5;465;1243;803;1183.155;1020.496;1.469039;True;True
...
WireConnection;137;9;108;0
WireConnection;137;4;107;0
WireConnection;137;6;76;4
WireConnection;137;7;142;0
WireConnection;137;8;37;0
ASEEND*/
//CHKSM=620CA11CA1A1F5C8C453620D1C7F89417BA97028
