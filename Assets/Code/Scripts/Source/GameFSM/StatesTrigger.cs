    ...
    public class StatesTrigger : MonoBehaviour
    {
        ...
        private void SwitchStates(GameBaseState state)
        {
            ...
            GameStateManager.Instance.SwitchState(state); 
              Debug.Log("Switch States trigerred" + "current states : " +   GameStateManager.Instance.CurrentState) ;
            _isTriggered = true;
        }
        ...
        public void LoungeToGreenhouse()
        {
            ...
            {
                SwitchStates(GameStateManager.Instance.GameStates.GreenhouseInProgress);
            }
        }
        ...
        {
            if ( GameStateManager.Instance.CurrentState == GameStateManager.Instance.GameStates.GreenhouseResolved) 
            {
                SwitchStates(GameStateManager.Instance.GameStates.LoungePhase2);
            }
        }
